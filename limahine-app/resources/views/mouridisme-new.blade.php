...
@section('title', 'Mouridisme - Limahine')
...
@section('content')
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div class="text-center group">
                    <div class="w-24 h-24 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                    ...
                    <h3 class="text-2xl font-bold text-amber-900 mb-4">Tawhîd</h3>
                ...
                <!-- Tarbiyya -->
                <div class="text-center group">
                    <div class="w-24 h-24 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-amber-900 mb-4">Tarbiyya</h3>
                    <p class="text-amber-700 leading-relaxed">
                ...
                <!-- Khidma -->
                <div class="text-center group">
                    <div class="w-24 h-24 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 515.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 919.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-amber-900 mb-4">Khidma</h3>
                    <p class="text-amber-700 leading-relaxed">
                ...
                <!-- Wird -->
                <div class="text-center group">
                    <div class="w-24 h-24 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-amber-900 mb-4">Wird</h3>
                    <p class="text-amber-700 leading-relaxed">
                ...
                <!-- Adab -->
                <div class="text-center group">
                    <div class="w-24 h-24 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-amber-900 mb-4">Adab</h3>
                    <p class="text-amber-700 leading-relaxed">
                ...
                <!-- Irshâd -->
                <div class="text-center group">
                    <div class="w-24 h-24 bg-gradient-to-br from-orange-500 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-amber-900 mb-4">Irshâd</h3>
                    <p class="text-amber-700 leading-relaxed">
    ...
    {{-- Citation inspirante --}}
    <section class="py-16 bg-gradient-to-r from-amber-600 to-yellow-600 text-white">
        <div class="container mx-auto px-6">
    ...
    <section id="enseignements" class="py-20 bg-amber-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-amber-900 mb-6">
                    Enseignements Principaux
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-amber-900">L'Éducation Spirituelle</h3>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-amber-900">Le Travail comme Adoration</h3>
                    </div>
                    <p class="text-amber-700 leading-relaxed mb-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-amber-900">L'Amour du Prophète ﷺ</h3>
                    </div>
                    <p class="text-amber-700 leading-relaxed mb-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-amber-900">La Science et la Sagesse</h3>
                    </div>
                    <p class="text-amber-700 leading-relaxed mb-4">
    ...
    @if($mouridismePublications->count() > 0)
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-amber-900 mb-6">
                    Publications sur le Mouridisme
                </h2>
                <p class="text-xl text-amber-700 max-w-3xl mx-auto leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($mouridismePublications as $publication)
                <article class="bg-white border border-amber-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
                    ...
                    @endif
                      <div class="p-6">
                        ...
                        <a href="{{ route('publications.show', $publication->slug) }}"
                           class="inline-flex items-center text-amber-700 hover:text-amber-800 font-medium">
                            Lire l'article
            ...
            <div class="text-center mt-12">
                <a href="{{ route('writing') }}?category=mouridisme"
    ...
    <section id="pratiques" class="py-20 bg-amber-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-amber-900 mb-6">
                    Pratiques Spirituelles
    ...
    {{-- Call to Action --}}
    <section class="py-20 bg-gradient-to-r from-amber-600 to-cyan-600 text-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-6">
                Approfondissez Votre Compréhension
            </h2>
            <p class="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
                Explorez nos ressources pour approfondir votre connaissance du mouridisme
