...
@section('content')
    ...
    <section class="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 py-20 pt-32">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex items-center justify-center space-x-6 text-amber-600 mb-8">
    ...
    <section class="py-8 bg-white border-b border-amber-100 sticky top-16 z-40">
        <div class="container mx-auto px-6">
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#academic-resources" class="px-6 py-2 rounded-full text-sm font-medium bg-amber-600 text-white hover:bg-amber-700 transition-colors">
                    Ressources Académiques
                </a>
                <a href="#theses-memoires" class="px-6 py-2 rounded-full text-sm font-medium bg-amber-100 text-amber-800 hover:bg-amber-200 transition-colors">
                    Thèses & Mémoires
                </a>
                <a href="#conferences" class="px-6 py-2 rounded-full text-sm font-medium bg-amber-100 text-amber-800 hover:bg-amber-200 transition-colors">
                    Conférences
                </a>
                <a href="#methodologie" class="px-6 py-2 rounded-full text-sm font-medium bg-amber-100 text-amber-800 hover:bg-amber-200 transition-colors">
                    Méthodologie
                </a>
            </div>
        </div>
    ...
    {{-- Thèses et Mémoires --}}
    <section id="theses-memoires" class="py-20 bg-amber-50">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <article class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-amber-100">
                    <div class="flex items-center justify-between mb-6">
                        <span class="bg-yellow-100 text-yellow-800 text-sm font-medium px-4 py-2 rounded-full">
                            {{ $academic::getTypes()[$academic->type] ?? $academic->type }}
                        </span>
                        @if($academic->date_publication)
                        <span class="text-amber-500 text-sm">{{ $academic->date_publication->format('Y') }}</span>
                        @endif
                    </div>
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-semibold text-amber-900 mb-2">Bientôt Disponible</h3>
                <p class="text-amber-700">Les thèses et mémoires seront prochainement ajoutés à notre collection.</p>
            </div>
            @endif
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-amber-100 to-yellow-100 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Théologie et Spiritualité</h3>
                ...
                <!-- Histoire et Société -->
                <div class="bg-gradient-to-br from-yellow-100 to-orange-100 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    <div class="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Histoire et Société</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-orange-100 to-amber-100 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Littérature et Poésie</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-amber-100 to-yellow-100 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Philosophie et Éthique</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-yellow-100 to-orange-100 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Économie et Développement</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-orange-100 to-amber-100 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Études Comparatives</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
    ...
    <section id="methodologie" class="py-20 bg-amber-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-amber-900 mb-6">
                    Méthodologie de Recherche
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <ul class="text-amber-700 space-y-3">
                            <li class="flex items-start">
                                <span class="w-2 h-2 bg-amber-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="text-center bg-amber-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
                    <div class="w-16 h-16 bg-amber-500 rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Partenariats Universitaires</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
                ...
                <div class="text-center bg-amber-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Réseau de Chercheurs</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
                ...
                <div class="text-center bg-amber-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-amber-900 mb-4">Publications Collaboratives</h3>
                    <p class="text-amber-700 text-sm leading-relaxed">
