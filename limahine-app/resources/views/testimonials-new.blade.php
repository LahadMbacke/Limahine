    ...
    <section class="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 py-20 pt-32">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex items-center justify-center space-x-4 text-amber-600">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-amber-700">Les témoignages les plus significatifs et émouvants de notre collection</p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                @foreach($featuredTemoignages->take(2) as $featured)
                <article class="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-8 border border-amber-200 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center justify-between mb-6">
                        <span class="bg-amber-100 text-amber-800 text-sm font-medium px-4 py-2 rounded-full flex items-center">
                    ...
                    </div>                    <h3 class="text-2xl font-bold text-amber-900 mb-4">
                        {{ $featured->getLocalizedTitle() ?? 'Témoignage' }}
                    </h3>

                    <blockquote class="text-amber-700 mb-6 leading-relaxed text-lg italic">
                    ...
                    <div class="border-t border-amber-200 pt-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="w-12 h-12 bg-amber-200 rounded-full flex items-center justify-center">
                                <span class="text-amber-700 font-semibold text-lg">
                                    {{ substr($featured->author_name, 0, 1) }}
                                </span>
                            </div>
                            @endif
                              <div class="flex-1">
                                <div class="font-semibold text-amber-900">{{ $featured->author_name }}</div>
                                @if($featured->getLocalizedAuthorTitle())
                                <div class="text-sm text-amber-600">{{ $featured->getLocalizedAuthorTitle() }}</div>
                                @endif
                                <div class="flex items-center mt-2 text-sm text-amber-500">
    ...
    <section class="py-16 bg-amber-50">
        <div class="container mx-auto px-6">
                ...
                <article class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <span class="bg-amber-100 text-amber-800 text-xs font-medium px-3 py-1 rounded-full flex items-center">
                        ...
                        {{-- Extrait du contenu --}}
                        <blockquote class="text-amber-700 mb-4 leading-relaxed italic">
                        ...
                        <div class="border-t border-amber-100 pt-4">
                            <div class="flex items-center space-x-3">
                                ...
                                @endif
                                  <div class="flex-1">
                                    <div class="font-semibold text-amber-900 text-sm">{{ $temoignage->author_name }}</div>
                                    @if($temoignage->getLocalizedAuthorTitle())
                                    <div class="text-xs text-amber-600">{{ $temoignage->getLocalizedAuthorTitle() }}</div>
                                    @endif
                                </div>
                            </div>

                            {{-- Métadonnées --}}
                            <div class="flex items-center justify-between mt-4 text-xs text-amber-500">
                                <div class="flex items-center">
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-semibold text-amber-900 mb-2">Aucun témoignage disponible</h3>
                <p class="text-amber-700 mb-6">Les témoignages seront bientôt disponibles.</p>
                <a href="{{ route('home') }}"
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-amber-900 mb-2">Authenticité</h3>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-amber-900 mb-2">Crédibilité</h3>
                        <p class="text-amber-700 text-sm">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-amber-900 mb-2">Préservation</h3>
                        <p class="text-amber-700 text-sm">
