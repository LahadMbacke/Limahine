    ...
    <section class="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 py-20 pt-32">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <h2 class="text-2xl md:text-3xl font-semibold text-amber-800 mb-6">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-amber-700">Les successeurs spirituels de Cheikh Ahmadou Bamba</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($khalifs as $khalif)
                <article class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-amber-100">
                    {{-- Image de couverture --}}
                    ...
                    @else
                    <div class="h-48 bg-gradient-to-br from-amber-400 to-yellow-500 flex items-center justify-center relative">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between text-sm text-amber-600 mb-4">
                            ...
                            <span class="text-amber-600 font-medium">Vivant</span>
                            @endif
                        </div>
    ...
    <section class="py-16 bg-amber-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-amber-700">Les descendants qui ont contribué à l'héritage spirituel</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <article class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                    ...
                    @else
                    <div class="h-40 bg-gradient-to-br from-amber-300 to-yellow-400 flex items-center justify-center">
                    ...
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-amber-900 mb-2 line-clamp-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('decouverte.show', $fils->slug) }}"
                               class="bg-amber-600 text-white px-3 py-1 rounded text-xs font-medium hover:bg-amber-700 transition-colors">
                                Voir
                            </a>
                        </div>
                    </div>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-amber-700">Les derniers contenus de la section Découverte</p>
            </div>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('writing') }}?category=decouverte"
                   class="bg-amber-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-amber-700 transition-colors">
